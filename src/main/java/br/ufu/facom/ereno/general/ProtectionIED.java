...
public class ProtectionIED extends IED {
    ...
    private int initialStNum = Integer.parseInt(ConfigLoader.setupIED.stNum);
    private int initialSqNum = Integer.parseInt(ConfigLoader.setupIED.sqNum);
    ...
    double minTime = Integer.parseInt(ConfigLoader.setupIED.minTime);
    long maxTime = Integer.parseInt(ConfigLoader.setupIED.maxTime);
    private boolean initialCbStatus = ConfigLoader.gooseFlow.cbstatus;
